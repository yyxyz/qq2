...
public class MainActivity extends AppCompatActivity
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mTabLayout.addTab(mTabLayout.newTab()
        ...
        .setIcon(R.mipmap.ic_notifications_black_24dp));//添加tab选项卡
    mTabLayout.addTab(
        mTabLayout.newTab().setText(titles.get(1)).setIcon(R.mipmap.ic_person_black_24dp));
    mTabLayout.addTab(
        mTabLayout.newTab().setText(titles.get(2)).setIcon(R.mipmap.ic_star_border_black_24dp));
